...
type Config struct {
	...
	// SignWrapper enables Notary Project X.509 signing of the localized wrapper
	// charts generated by [Config.Localize]. The signature is pushed to the
	// target registry as a referrer of the wrapper artifact. Signing key
	// material is resolved from the credential graph via a NotationSigner
	// consumer identity scoped to the target registry.
	//
	// SignWrapper requires [Config.Localize].
	SignWrapper bool `json:"signWrapper,omitempty"`
}
